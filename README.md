...
[![npm](https://img.shields.io/npm/v/chives-api.svg?style=flat-square)](https://registry.npmjs.org/chives-api)

## Usage example

```js
const { readFileSync } = require('fs');
const { Connection, constants, ApiClient } = require('chives-api');

(async () => {
  const conn = new Connection('localhost:56900', {
...
A Changelog can be found [here](https://github.com/MinerGreggy/chives-api/blob/master/CHANGELOG.md)

## License

GNU GPLv3 (see [LICENSE](https://github.com/MinerGreggy/chives-api/blob/master/LICENSE))
